            ...
            Column{
                OutlinedButton(
                    ...
                    modifier = Modifier
                        ...
                        .fillMaxWidth()
                        .height(50.dp),
                    border = BorderStroke(1.dp, BlackStrock),
                ...
                Row (
                    ...
                    HorizontalDivider(modifier = Modifier.weight(1f), color = GreyStrock)
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Email", color = GreyStrock) },
                    placeholder = { Text("Email", color = GreyStrock) },
                    modifier = Modifier
                        .fillMaxWidth()
                    ...
                    colors = TextFieldDefaults.outlinedTextFieldColors(
                        ...
                        unfocusedBorderColor = GreyStrock
                    )
                )
                // Password TextField
                OutlinedTextField(
                    ...
                    label = { Text("Password", color = GreyStrock) },
                    placeholder = { Text("Password", color = GreyStrock) },
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(vertical = 8.dp),
